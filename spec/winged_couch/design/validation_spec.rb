  ...
  module Design
    describe Validation do
      ...
      it "uploads validation function to specified database" do
        ...
        database.get("/_design/validation_name")["validate_doc_update"].should eq(name_validation)
      end
      ...
      it "stores multiple validations for same model" do
        ...
        database.get("/_design/validation_name")["validate_doc_update"].should eq(name_validation)
        database.get("/_design/validation_age")["validate_doc_update"].should eq(age_validation)
      end
