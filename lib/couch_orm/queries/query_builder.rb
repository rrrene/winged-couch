require 'couch_orm/queries/base_builder'
require 'couch_orm/queries/strategies'
require 'couch_orm/queries/dsl'
...
module CouchORM
  module Queries
    ...
    class QueryBuilder < BaseBuilder
      ...
      #
      # @return [Array<CouchORM::Model>] when raw: false passed
